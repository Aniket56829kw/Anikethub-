...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [Aniket Movies™](https://t.me/Aniket_Movies_hub)</b>⚡\n\n🎦 <b>File Name: </b> ➥  <i>{file_caption}</i>\n⚙️ <b>Size: </b><i>{file_size}</i>\n\n                ❤️<b>WE LOVE YOU</b>❤️\n🔥  ↭ <b>Join Now [Aniket Movies™](https://t.me/Aniket_Movies_hub)</b> ↭  🔥")
...
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','@Aniket_Movies_hub') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','Aniket_Movies_hub') # WITHOUT @
LAZY_YT_HANDLE = environ.get('Join Our Channel','Aniket_Movies_hub')  # WITHOUT @ [  add only handle - don't add full url  ] 
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "Aniket_movies_Search") #[ without @ ]
